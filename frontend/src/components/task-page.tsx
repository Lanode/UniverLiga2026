...
export function TaskPage() {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Left Sidebar */}
      <div className="hidden md:flex w-64 flex-col justify-between items-start p-8 bg-secondary">
        {/* Logo Section */}
        <div className="flex items-center gap-2">
          ...
          >
            <path
              ...
              stroke="var(--Color, #FF383C)"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          </svg>
          <span className="text-xl font-semibold text-[var(--Color,#FF383C)]">
            CRM-система
          </span>
        </div>
